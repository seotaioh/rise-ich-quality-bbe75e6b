...
CREATE TABLE IF NOT EXISTS public.model_code_options (
...
CREATE TABLE IF NOT EXISTS public.model_defect_types (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  model_id TEXT NOT NULL,
...
DROP POLICY IF EXISTS "Allow public read" ON public.model_code_options;
DROP POLICY IF EXISTS "Allow public insert" ON public.model_code_options;
DROP POLICY IF EXISTS "Allow public update" ON public.model_code_options;
DROP POLICY IF EXISTS "Allow public delete" ON public.model_code_options;
...
DROP POLICY IF EXISTS "Allow public read" ON public.model_defect_types;
DROP POLICY IF EXISTS "Allow public insert" ON public.model_defect_types;
DROP POLICY IF EXISTS "Allow public update" ON public.model_defect_types;
DROP POLICY IF EXISTS "Allow public delete" ON public.model_defect_types;
...
-- 인덱스 추가
CREATE INDEX IF NOT EXISTS idx_model_code_options_model ON public.model_code_options(model_id);
CREATE INDEX IF NOT EXISTS idx_model_defect_types_model ON public.model_defect_types(model_id);
